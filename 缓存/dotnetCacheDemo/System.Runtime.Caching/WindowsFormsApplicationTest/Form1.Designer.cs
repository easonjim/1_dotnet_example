namespace WindowsFormsApplicationTest
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button4.Text = "局部变量重新创建同名实例并获取全局实例的值";
            ...
            this.button5.Text = "再进行设置全局变量的值，然后再次点击上面按钮获取";
